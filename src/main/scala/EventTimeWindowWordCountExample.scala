...
object EventTimeWindowWordCountExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = Seq(("Hello", "2018-02-24 16:35:09"), ("world", "2018-02-24 16:35:09"), ("Hello", "2018-02-24 16:35:09"), ("Adam", "2018-02-24 16:35:09")).toDF("word", "ts")
    ...
    val windowedCounts = df.groupBy(window($"ts", "10 minutes", "5 minutes"),
      $"word"
    ).count()
